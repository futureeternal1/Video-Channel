...
public class AppConfig {
    ...
    public static final String SERVER_KEY = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";

    //your Rest API Key obtained from the admin panel
    public static final String REST_API_KEY = "xxxxxxxxxxxxxxxxxxxxxxxxxx";
    ...
    public static final boolean ALLOW_APP_ACCESSED_USING_VPN = false;
